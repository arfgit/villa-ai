import type { LlmSceneResponse, LlmBatchSceneResponse, Emotion, SystemEventType } from '@villa-ai/shared'
...
export function parseAndValidate(
  ...
  // Ensure all required speakers have at least one line (minigame/challenge)
