      ...
      {enabled &&
        ...
        createPortal(
          <div
            ...
            role="tooltip"
            className={clsx(
              "fixed z-[9999] pointer-events-none border border-villa-pink bg-villa-bg text-villa-ink px-2.5 py-2 text-[11px] leading-snug w-[280px] max-h-[80vh] overflow-y-auto shadow-2xl shadow-black/60 whitespace-pre-line",
              coords?.measured
                ? "opacity-100 animate-villa-fadein"
                : "opacity-0",
            )}
            style={{
              top: coords?.top ?? -9999,
