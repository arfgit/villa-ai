      ...
      {bp === 'desktop' ? (
        <div className="flex-1 grid grid-cols-[260px_1fr_320px] gap-3 p-3 overflow-hidden">
          <div className="overflow-hidden">
            <CastList cast={cast} emotions={episode.emotions} couples={episode.couples} eliminatedIds={episode.eliminatedIds} winnerCouple={episode.winnerCouple} locations={episode.locations} currentSceneType={currentSceneType} brains={episode.brains} />
          </div>
